...
struct Connection {
	...
	Connection(boost::asio::io_service& io_service, int ID)		// Creates a Connection with io_service, which facilitates ansynchrony. 
		: socket(io_service), read_buffer(), ID(ID) { }
